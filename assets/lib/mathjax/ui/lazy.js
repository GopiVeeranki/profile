!(function () {
      ...
      335: function (t, e, r) {
        var a,
          ...
          i =
            ...
            function (t, e) {
              for (var r = 0, a = e.length, n = t.length; r < a; r++, n++)
                t[n] = e[r];
              return t;
            },
          l =
            ...
            return (
              ...
              (r.prototype.state = function (e, r) {
                return (
                  void 0 === e && (e = void 0),
                  void 0 === r && (r = !1),
                  null === r ? this._state : t.prototype.state.call(this, e, r)
                );
              }),
              r
            );
          ...
          return (function (t) {
            function r() {
              ...
              (a.lazyPromise = Promise.resolve()),
                (a.lazyIdle = !1),
                (a.lazySet = new Set()),
                (a.options.MathItem = c(a.options.MathItem)),
                (a.lazyObserver = new IntersectionObserver(
                  a.lazyObserve.bind(a)
                )),
                (a.lazyList = new u());
              var n = a.lazyHandleSet.bind(a);
              return (
                (a.lazyProcessSet =
                  "undefined" != typeof window && window.requestIdleCallback
                    ? function () {
                        return window.requestIdleCallback(n);
                      }
                    : function () {
                        return setTimeout(n, 10);
                      }),
                a
              );
            }
            return (
              ...
              (r.prototype.lazyObserve = function (t) {
                ...
                try {
                  for (var n = l(t), o = n.next(); !o.done; o = n.next()) {
                    var i = o.value,
                      s = this.adaptor.getAttribute(i.target, e.LAZYID);
                    this.lazyList.get(s) &&
                      (i.isIntersecting
                        ? (this.lazySet.add(s),
                          this.lazyIdle ||
                            ((this.lazyIdle = !0), this.lazyProcessSet()))
                        : this.lazySet.delete(s));
                  }
                } catch (t) {
                  r = { error: t };
                } finally {
              ...
              (r.prototype.resetStates = function (t, e) {
                ...
                try {
                  for (
                    var n = l(t.values()), o = n.next();
                    !o.done;
                    o = n.next()
                  ) {
                    var i = o.value,
                      y = this.lazyList.get(i);
                    y.lazyCompile
                      ? (y.state(s.STATE.COMPILED - 1), (e = s.STATE.COMPILED))
                      : y.state(s.STATE.TYPESET - 1),
                      (y.lazyCompile = y.lazyTypeset = !1),
                      y.lazyMarker && this.lazyObserver.unobserve(y.lazyMarker);
                  }
                } catch (t) {
                  r = { error: t };
                } finally {
              ...
              (r.prototype.compileEarlierItems = function (t) {
                ...
                try {
                  for (
                    var o = l(this.math), i = o.next();
                    !i.done;
                    i = o.next()
                  ) {
                    var y = i.value;
                    if (y === a || !(null == y ? void 0 : y.lazyCompile)) break;
                    (y.lazyCompile = !1),
                      y.lazyMarker && this.lazyObserver.unobserve(y.lazyMarker),
                      y.state(s.STATE.COMPILED - 1),
                      (n = !0);
                  }
                } catch (t) {
                  e = { error: t };
              ...
              (r.prototype.earliestTex = function (t) {
                ...
                try {
                  for (
                    var o = l(t.values()), i = o.next();
                    !i.done;
                    i = o.next()
                  ) {
                    var s = i.value,
                      y = this.lazyList.get(s);
                    y.lazyTex &&
                      (null === a || parseInt(s) < a) &&
                      ((a = parseInt(s)), (n = y));
                  }
              ...
              (r.prototype.clearMathItemsWithin = function (r) {
                ...
                try {
                  for (var i = l(o), s = i.next(); !s.done; s = i.next()) {
                    var y = s.value.lazyMarker;
                    y &&
                      (this.lazyObserver.unobserve(y),
                      this.lazyList.delete(
                        this.adaptor.getAttribute(y, e.LAZYID)
                      ));
                  }
                } catch (t) {
                  a = { error: t };
        ...
        (e.LazyList = u),
          ...
          (e.LazyMathItemMixin = c),
          (e.LazyMathDocumentMixin = h),
          (e.LazyHandler = function (t) {
            return (
              "undefined" != typeof IntersectionObserver &&
                (t.documentClass = h(t.documentClass)),
              t
            );
          });
      },
  ...
  function n(t) {
    ...
    var o = (a[t] = { exports: {} });
    return r[t].call(o.exports, o, o.exports, n), o.exports;
  }
  (t = n(723)),
    (e = n(335)),
    (0, t.r8)({ _: { ui: { lazy: { LazyHandler: e } } } }),
    MathJax.startup &&
      MathJax.startup.extendHandler(function (t) {
        return (0, e.LazyHandler)(t);
      });
})();
