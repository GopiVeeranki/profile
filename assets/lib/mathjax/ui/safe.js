!(function () {
        ...
        e.SafeMethods = {
          ...
          filterSizeMultiplier: function (t, e) {
            var r = a(
              ...
              n = r[0],
              i = r[1];
            return Math.min(i, Math.max(n, parseFloat(e)));
          },
          filterScriptLevel: function (t, e) {
            var r = a(t.options.scriptlevelRange || [-1 / 0, 1 / 0], 2),
              n = r[0],
              i = r[1];
            return Math.min(i, Math.max(n, parseInt(e)));
          },
          ...
          l = (function () {
            ...
            return (
              ...
              (t.OPTIONS = {
                ...
                styleParts: i.expandable({
                  border: !0,
                  padding: !0,
                  margin: !0,
                  outline: !0,
                }),
                styleLengths: i.expandable({
  ...
  (t = o(723)),
    ...
    (n = o(477)),
    (0, t.r8)({
      _: { ui: { safe: { SafeHandler: e, SafeMethods: r, safe: n } } },
    }),
    MathJax.startup &&
      "undefined" != typeof window &&
      MathJax.startup.extendHandler(function (t) {
        return (0, e.SafeHandler)(t);
      });
})();
