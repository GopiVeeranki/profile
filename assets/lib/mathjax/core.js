!(function () {
                      ...
                      try {
                        for (
                          ...
                          if (m.processStrings) {
                            ...
                            try {
                              for (
                                var L = ((l = void 0), s(m.findMath(M))),
                                  N = L.next();
                                !N.done;
                                N = L.next()
                              ) {
                                var R = N.value;
                                g.push(this.mathItem(R, m, E));
                              }
                            } catch (t) {
                              l = { error: t };
                            } finally {
  ...
  function Rt(t) {
    ...
    var r = (Nt[t] = { exports: {} });
    return Lt[t].call(r.exports, r, r.exports, Rt), r.exports;
  }
  (Rt.g = (function () {
    ...
    (0, t.combineWithMathJax)({
      _: {
        adaptors: { HTMLAdaptor: e, browserAdaptor: r },
        components: { global: t },
        core: {
          DOMAdaptor: n,
          FindMath: o,
          ...
          MmlTree: {
            ...
            MmlVisitor: G,
            OperatorDictionary: V,
            SerializedMmlVisitor: U,
          },
          OutputJax: K,
          Tree: {
            Factory: $,
    ...
    MathJax.startup &&
      (MathJax.startup.registerConstructor("HTMLHandler", it.HTMLHandler),
      MathJax.startup.registerConstructor("browserAdaptor", r.browserAdaptor),
