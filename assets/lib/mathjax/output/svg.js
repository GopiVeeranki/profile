!(function () {
    ...
    dt = {
      9250: function (t, e, r) {
        ...
        var l = (function () {
          function t(t) {
            ...
            (this.options = s.userOptions(s.defaultOptions({}, h.OPTIONS), t)),
              (this.params = o({}, h.defaultParams)),
              (this.sizeVariants = i([], n(h.defaultSizeVariants))),
              (this.stretchVariants = i([], n(h.defaultStretchVariants))),
          ...
          f = (function (t) {
            function e(e, r, o) {
              void 0 === e && (e = null),
                ...
                void 0 === o && (o = null);
              var n = this,
                i = a(h.separateOptions(e, o.OPTIONS), 2),
                s = i[0],
                l = i[1];
              return (
              ...
              (e.prototype.getMetricMaps = function (t) {
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var P = ((u = void 0), s(f[w].values())), V = P.next();
                        !V.done;
                        V = P.next()
                      ) {
                        C = V.value;
          ...
          return (function (t) {
            ...
            return (
              ...
              (e.prototype.getNotations = function () {
                ...
                try {
                  for (
                    var o = s(c.split(this.node.attributes.get("notation"))),
                      n = o.next();
                    !n.done;
                    n = o.next()
                  ) {
                ...
                try {
                  for (
                    ...
                    if (this.notations[a]) {
                      ...
                      try {
                        for (
                          var c = ((r = void 0), s(l.split(/ /))), h = c.next();
                          !h.done;
                          h = c.next()
                        ) {
                          var u = h.value;
              ...
              (e.prototype.arrowData = function () {
                var t = i([this.padding, this.thickness], 2),
                  ...
                  h = Math.max(e, (r * s) / c),
                  u = Math.max(e, (r * l) / c),
                  p = i(this.getArgMod(s + 2 * h, l + 2 * u), 2);
              ...
              (e.prototype.arrowAW = function () {
                var t = this.childNodes[0].getBBox(),
                  ...
                  l = n[2],
                  c = n[3];
                return this.getArgMod(c + o + s, a + e + r + l);
              }),
            ...
            return (
              ...
              (e.prototype.computeBBox = function (t, e) {
                ...
                if (this.node.attributes.get("equalrows")) {
                  ...
                  r =
                    h.sum([].concat(this.rLines, this.rSpace)) +
                    l * this.numRows;
                } else r = h.sum(a.concat(s, this.rLines, this.rSpace));
                r += 2 * (this.fLine + this.fSpace[1]);
                var u = this.getComputedWidths();
                o =
                  h.sum(u.concat(this.cLines, this.cSpace)) +
                ...
                var m = i(this.getBBoxLR(), 2),
                  v = m[0],
                  g = m[1];
                (t.L = v), (t.R = g), c.isPercent(p) || this.setColumnPWidths();
              }),
              (e.prototype.setChildPWidths = function (t, e, r) {
                var o = this.node.attributes.get("width");
                if (!c.isPercent(o)) return !1;
                this.hasLabels ||
                ...
                return (
                  (this.pWidth =
                    h.sum(d.concat(this.cLines, this.cSpace)) +
                    2 * (this.fLine + this.fSpace[0])),
              ...
              (e.prototype.getEqualColumns = function (t) {
                ...
                if ("auto" === t) {
                  ...
                  var n =
                    h.sum([].concat(this.cLines, this.cSpace)) +
                    2 * this.fSpace[0];
              ...
              ((e = (function (t) {
                ...
                return (
                  ...
                  (e.prototype.getDeltaW = function (t, e) {
                    ...
                    h[0] -=
                      ...
                      !this.baseCore.node.attributes.get("largeop")
                        ? this.baseIc
                        : 0;
                    var u = Math.max.apply(Math, i([], n(h))),
                      p = [],
                      d = 0;
                    try {
                      for (
                        var f = a(h.keys()), y = f.next();
                        !y.done;
                        y = f.next()
                      ) {
                        var m = y.value;
                  ...
                  (e.prototype.stretchChildren = function () {
                    ...
                    try {
                      for (
                        var l = a(this.childNodes), c = l.next();
                        !c.done;
                        c = l.next()
                      ) {
                        (M = c.value).canStretch(2) && s.push(M);
                      }
                    } catch (e) {
                      t = { error: e };
                    } finally {
                    ...
                    if (h && u > 1) {
                      ...
                      try {
                        for (
                          var f = a(this.childNodes), y = f.next();
                          !y.done;
                          y = f.next()
                        ) {
      ...
      9708: function (t, e, r) {
        ...
        (e.SVGFontData = c),
          (e.AddPaths = function (t, e, r) {
            ...
            try {
              for (
                var l = s(Object.keys(e)), h = l.next();
                !h.done;
                h = l.next()
              ) {
                var u = h.value,
                  p = parseInt(u);
                c.charOptions(t, p).p = e[p];
              }
            } catch (t) {
              o = { error: t };
            } finally {
            ...
            try {
              for (
                var d = s(Object.keys(r)), f = d.next();
                !f.done;
                f = d.next()
              ) {
                (u = f.value), (p = parseInt(u));
                c.charOptions(t, p).c = r[p];
              }
            } catch (t) {
              i = { error: t };
            } finally {
      ...
      9737: function (t, e, r) {
        ...
        e.lineData = function (t, r, o) {
          ...
          var n = t.getBBox(),
            ...
            s = n.w,
            l = t.thickness / 2;
          return e.lineOffset(e.computeLineData[r](i, a, s, l), t, o);
        };
        ...
        e.RenderLine = function (t, r) {
          return (
            void 0 === r && (r = ""),
            function (o, n) {
              var i = o.line(e.lineData(o, t, r));
              o.adaptor.append(o.element, i);
            }
          );
        };
        e.Border = function (t) {
          return i.CommonBorder(function (r, o) {
            r.adaptor.append(r.element, r.line(e.lineData(r, t)));
          })(t);
        };
        e.Border2 = function (t, r, o) {
          return i.CommonBorder2(function (t, n) {
            t.adaptor.append(t.element, t.line(e.lineData(t, r))),
              t.adaptor.append(t.element, t.line(e.lineData(t, o)));
          })(t, r, o);
        };
        e.DiagonalStrike = function (t) {
          return i.CommonDiagonalStrike(function (r) {
            return function (r, o) {
              r.adaptor.append(r.element, r.line(e.lineData(r, t)));
            };
          })(t);
            ...
            return (
              ...
              (e.prototype.addChildren = function (t) {
                ...
                try {
                  for (
                    ...
                    var s = a.value;
                    s.toSVG(t),
                      s.element && s.place(o + s.bbox.L * s.bbox.rscale, 0),
                      (o += (s.bbox.L + s.bbox.w + s.bbox.R) * s.bbox.rscale);
                  }
                } catch (t) {
                  e = { error: t };
                } finally {
              ...
              (e.prototype.handleColor = function () {
                var t = this.adaptor,
                  ...
                  n = e.getExplicit("mathbackground"),
                  i = e.getExplicit("background");
                if (
                  ((r || o) &&
                    (t.setAttribute(this.element, "fill", r || o),
                    t.setAttribute(this.element, "stroke", r || o)),
                  n || i)
                ) {
                  var a = this.getBBox(),
                    s = a.h,
                    ...
                    h = this.svg("rect", {
                      ...
                      y: this.fixed(-l),
                      width: this.fixed(c),
                      height: this.fixed(s + l),
                      "data-bgcolor": !0,
                    }),
                    u = t.firstChild(this.element);
                  u ? t.insert(h, u) : t.append(this.element, h);
                }
              }),
              ...
              (e.prototype.place = function (t, e, r) {
                if ((void 0 === r && (r = null), t || e)) {
                  ...
                  var o =
                      "translate(" + this.fixed(t) + "," + this.fixed(e) + ")",
              ...
              (e.prototype.handleId = function (t) {
                ...
                var n = this.svg(
                  ...
                  {
                    "data-idbox": !0,
                    transform: "translate(0," + this.fixed(-r) + ")",
                  },
                  o
                );
                return (
              ...
              (e.prototype.useNode = function (t, e, r) {
                ...
                return this.adaptor.setAttribute(o, "href", n, l.XLINKNS), o;
              }),
      ...
      4687: function (t, e, r) {
        ...
        e.SVGWrappers =
          ...
          (o[V.SVGTeXAtom.kind] = V.SVGTeXAtom),
          (o[A.SVGTextNode.kind] = A.SVGTextNode),
      ...
      484: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          })(a.CommonTeXAtomMixin(i.SVGWrapper));
        e.SVGTeXAtom = c;
      },
      7455: function (t, e, r) {
        var o,
        ...
        var a = r(8921),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.toSVG = function (t) {
                ...
                if ("-explicitFont" === n)
                  this.adaptor.append(t, this.jax.unknownText(o, n));
                else {
          ...
          })(r(555).CommonTextNodeMixin(s.SVGWrapper));
        e.SVGTextNode = l;
      },
      4601: function (t, e, r) {
        var o,
        ...
        var i = r(9321),
          ...
          })(a.CommonMactionMixin(i.SVGWrapper));
        e.SVGmaction = c;
      },
      1211: function (t, e, r) {
        var o,
        ...
        var s = r(9321),
          ...
          })(l.CommonMathMixin(s.SVGWrapper));
        e.SVGmath = u;
      },
      144: function (t, e, r) {
        var o,
        ...
        var s = r(9321),
            ...
            return (
              ...
              (e.prototype.toSVG = function (t) {
                var e,
                  ...
                  a = {};
                n > 0 && (a.transform = "translate(" + this.fixed(n) + ", 0)");
                var s = this.adaptor.append(o, this.svg("g", a));
                this.renderChild
                  ? this.renderChild(this, s)
                  : this.childNodes[0].toSVG(s);
                try {
                  for (
                    var l = i(Object.keys(this.notations)), c = l.next();
                    !c.done;
                    c = l.next()
                  ) {
                    var h = c.value,
              ...
              (e.kind = h.MmlMenclose.prototype.kind),
              (e.notations = new Map([
                c.Border("top"),
                c.Border("right"),
                c.Border("bottom"),
                ...
                c.DiagonalStrike("up"),
                c.DiagonalStrike("down"),
                [
                  "horizontalstrike",
                  {
                    renderer: c.RenderLine("horizontal", "Y"),
                    bbox: function (t) {
                ...
                [
                  "verticalstrike",
                  {
                    renderer: c.RenderLine("vertical", "X"),
                    bbox: function (t) {
          ...
          })(l.CommonMencloseMixin(s.SVGWrapper));
        e.SVGmenclose = u;
      },
      3007: function (t, e, r) {
        var o,
      ...
      5258: function (t, e, r) {
        ...
        var a = r(9321),
          ...
          })(s.CommonMfencedMixin(a.SVGWrapper));
        e.SVGmfenced = c;
      },
      9295: function (t, e, r) {
        var o,
            ...
            return (
              ...
              (e.prototype.makeBevelled = function (t) {
                ...
                o.toSVG(e),
                  ...
                  n.place(p + this.bevel.getBBox().w + u.L * u.rscale - c, l);
              }),
              (e.kind = l.MmlMfrac.prototype.kind),
              e
            );
          })(s.CommonMfracMixin(a.SVGWrapper));
        e.SVGmfrac = c;
      },
      4916: function (t, e, r) {
        var o,
        ...
        var i = r(9321),
          ...
          })(a.CommonMglyphMixin(i.SVGWrapper));
        e.SVGmglyph = l;
      },
      2983: function (t, e, r) {
        var o,
      ...
      4750: function (t, e, r) {
        ...
        var a = r(7522),
            ...
            return (
              ...
              (e.prototype.toSVG = function (t) {
                ...
                h.toSVG(e),
                  h.place(c, 0),
                  (c += h.getBBox().w),
                  r.numScripts && this.addScripts(c, s, l, !1, 1, r.numScripts);
              }),
              (e.prototype.addScripts = function (t, e, r, o, n, a) {
                var s = this.adaptor,
                  l = s.append(this.element, this.svg("g")),
                  c = s.append(this.element, this.svg("g"));
                this.place(t, e, l), this.place(t, r, c);
                for (var h = n + 2 * a, u = 0; n < h; ) {
                  var p = i([this.childNodes[n++], this.childNodes[n++]], 2),
                    d = p[0],
                    f = p[1],
                    y = i([d.getBBox(), f.getBBox()], 2),
                    m = y[0],
                    v = y[1],
                    g = i([m.rscale, v.rscale], 2),
                    b = g[0],
                    x = g[1],
                    _ = Math.max(m.w * b, v.w * x);
                  d.toSVG(c),
                    f.toSVG(l),
                    d.place(u + (o ? _ - m.w * b : 0), 0),
                    f.place(u + (o ? _ - v.w * x : 0), 0),
                    (u += _);
                }
                return t + u;
              }),
          ...
          })(s.CommonMmultiscriptsMixin(a.SVGmsubsup));
      ...
      4539: function (t, e, r) {
        ...
        var a = r(9321),
          ...
          })(s.CommonMpaddedMixin(a.SVGWrapper));
        e.SVGmpadded = c;
      },
      438: function (t, e, r) {
        var o,
      ...
      322: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          })(a.CommonMrowMixin(i.SVGWrapper));
        e.SVGmrow = c;
        var h = (function (t) {
          function e() {
            return (null !== t && t.apply(this, arguments)) || this;
      ...
      2458: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          })(a.CommonMspaceMixin(i.SVGWrapper));
        e.SVGmspace = l;
      },
      9948: function (t, e, r) {
        var o,
        ...
        var i = r(9321),
            ...
            return (
              ...
              (e.prototype.toSVG = function (t) {
                var e = this.childNodes[this.surd],
                  ...
                  a = r.getBBox(),
                  s = this.getPQ(i)[1],
                  l = this.font.params.rule_thickness * this.bbox.scale,
                  c = a.h + s + l,
                  h = this.standardSVGnode(t),
                  u = this.adaptor.append(h, this.svg("g"));
                this.addRoot(h, o, i, c),
                  e.toSVG(h),
                  e.place(this.dx, n.h - i.h - l),
                  r.toSVG(u),
                  r.place(this.dx + i.w, 0),
                  this.adaptor.append(
                    h,
                    this.svg("rect", {
                      width: this.fixed(a.w),
                      height: this.fixed(l),
                      x: this.fixed(this.dx + i.w),
                      y: this.fixed(n.h - 2 * l),
                    })
                  );
              }),
              (e.prototype.addRoot = function (t, e, r, o) {}),
          ...
          })(a.CommonMsqrtMixin(i.SVGWrapper));
        e.SVGmsqrt = l;
      },
      7522: function (t, e, r) {
        var o,
        ...
        var a = r(1269),
          ...
          })(s.CommonMsubMixin(a.SVGscriptbase));
        e.SVGmsub = u;
        var p = (function (t) {
          function e() {
            return (null !== t && t.apply(this, arguments)) || this;
        ...
        })(l.CommonMsupMixin(a.SVGscriptbase));
        e.SVGmsup = p;
        var d = (function (t) {
          function e() {
            return (null !== t && t.apply(this, arguments)) || this;
        ...
        })(c.CommonMsubsupMixin(a.SVGscriptbase));
        e.SVGmsubsup = d;
      },
      451: function (t, e, r) {
        var o,
        ...
        var s = r(9321),
              ...
              (e.prototype.placeRows = function (t) {
                for (
                  var e,
                    ...
                    p = a(a([this.fLine], i(this.rLines)), [this.fLine]),
              ...
              (e.prototype.topTable = function (t, e, r) {
                var o = this.adaptor,
                  ...
                  v =
                    ...
                    ")",
                  g = "translate(0 " + this.fixed(a) + ") " + m + " " + v,
                  b = this.svg(
                    "svg",
                    {
                      "data-table": !0,
          ...
          })(l.CommonMtableMixin(s.SVGWrapper));
        e.SVGmtable = h;
      },
      2673: function (t, e, r) {
        var o,
      ...
      1941: function (t, e, r) {
        ...
        var i = r(9321),
          ...
          })(a.CommonMtextMixin(i.SVGWrapper));
        e.SVGmtext = l;
      },
      4682: function (t, e, r) {
        var o,
              ...
              (e.prototype.placeCells = function (t) {
                for (
                  var e = this.parent.getColumnHalfSpacing(),
                    r = a(a([this.parent.fLine], i(this.parent.cLines)), [
                      this.parent.fLine,
                    ]),
      ...
      4299: function (t, e, r) {
            ...
            (e.prototype.toSVG = function (e) {
              if (this.hasMovableLimits()) t.prototype.toSVG.call(this, e);
                ...
                var r = this.standardSVGnode(e),
                  ...
                  a = o[1],
                  s = o[2],
                  l = i([n.getBBox(), a.getBBox(), s.getBBox()], 3),
                  c = l[0],
                  h = l[1],
                  u = l[2];
        ...
        })(c.CommonMunderoverMixin(a.SVGmsubsup));
        e.SVGmunderover = d;
      },
      1269: function (t, e, r) {
        var o,
        ...
        var a = r(9321),
          ...
          })(r(7091).CommonScriptbaseMixin(a.SVGWrapper));
        e.SVGscriptbase = s;
      },
      6965: function (t, e, r) {
        var o,
        ...
        var i = r(9321),
          ...
          })(a.CommonSemanticsMixin(i.SVGWrapper));
        e.SVGsemantics = c;
        var h = (function (t) {
          function e() {
            return (null !== t && t.apply(this, arguments)) || this;
  ...
  function yt(t) {
    ...
    var r = (ft[t] = { exports: {} });
    return dt[t].call(r.exports, r, r.exports, yt), r.exports;
  }
  (yt.n = function (t) {
    var e =
      t && t.__esModule
    ...
    MathJax.startup &&
      (MathJax.startup.registerConstructor("svg", T.SVG),
