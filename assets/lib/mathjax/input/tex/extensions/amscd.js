!(function () {
  ...
  var e,
    ...
    o = {
      769: function (e, t, a) {
        ...
        var o = a(251);
        a(704),
          (t.AmsCdConfiguration = o.Configuration.create("amscd", {
            handler: {
      ...
      704: function (e, t, a) {
        ...
        new o.EnvironmentMap(
          ...
          new o.MacroMap("amscd_special", { "@": "arrow" }, r.default);
      },
      834: function (e, t, a) {
        Object.defineProperty(t, "__esModule", { value: !0 });
        var o = a(193),
          ...
          l = {
            CD: function (e, t) {
              ...
              var a = e.itemFactory.create("array"),
                o = e.configuration.options.amscd;
              return (
                a.setProperties({
                  minw: e.stack.env.CD_minw || o.harrowsize,
                  minh: e.stack.env.CD_minh || o.varrowsize,
                }),
                (a.arraydef = {
                  columnalign: "center",
                  columnspacing: o.colspace,
                  rowspacing: o.rowspace,
                  displaystyle: !0,
                }),
                a
              );
            ...
            arrow: function (e, t) {
              ...
              if (!a.match(/[><VA.|=]/)) return n.Other(e, t);
              e.i++;
              var c = e.stack.Top();
              (c.isKind("array") && !c.Size()) ||
                (l.cell(e, t), (c = e.stack.Top()));
              for (
                var s,
                  m = c,
                  d = m.table.length % 2 == 1,
                  u = (m.row.length + (d ? 0 : 1)) % 2;
                u;

              )
                l.cell(e, t), u--;
              var p = { minsize: m.getProperty("minw"), stretchy: !0 },
                M = {
                  minsize: m.getProperty("minh"),
                  stretchy: !0,
                  symmetric: !0,
                  lspace: 0,
                  rspace: 0,
                ...
                if (">" === a || "<" === a) {
                  if (
                    ...
                    if (((s = e.create("node", "munderover", [s])), h)) {
                      var b = new o.default(
                        ...
                        C = e.create("node", "mpadded", [b], x);
                      i.default.setAttribute(C, "voffset", ".1em"),
                        i.default.setChild(s, s.over, C);
                    }
                    if (_) {
                      var g = new o.default(
                        _,
                  ...
                  (s = v),
                    (h || _) &&
                      ...
                      (v.texClass = r.TEXCLASS.ORD),
                      i.default.appendChildren(s, [v]),
                      _ &&
                        i.default.appendChildren(s, [
                          new o.default(
                            "\\scriptstyle\\rlap{" + _ + "}",
  ...
  (e = r(955)),
    ...
    (0, e.r8)({
      _: {
        input: { tex: { amscd: { AmsCdConfiguration: t, AmsCdMethods: a } } },
      },
    });
})();
