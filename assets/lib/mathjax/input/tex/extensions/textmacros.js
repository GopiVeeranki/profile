!(function () {
    ...
    o = {
      762: function (t, e, a) {
        ...
        a(557),
            ...
            fallback: {
              ...
              macro: function (t, e) {
                var a = t.texParser,
                  n = a.lookup("macro", e);
                n &&
                  n._func !== l.TextMacrosMethods.Macro &&
                  t.Error(
                    "MathMacro",
          ...
          (e.TextMacrosConfiguration = o.Configuration.create("textmacros", {
            config: function (t, e) {
              var a = new o.ParserConfiguration(
                e.parseOptions.options.textmacros.packages,
                ["tex", "text"]
              );
              a.init();
              var n = new r.default(a, []);
              (n.options = e.parseOptions.options),
                a.config(e),
                s.TagsFactory.addTags(a.tags),
      ...
      807: function (t, e, a) {
        ...
        e.TextMacrosMethods = {
          ...
          Math: function (t, e) {
            t.saveText();
            for (var a, o, r = t.i, s = 0; (o = t.GetNext()); )
              switch (((a = t.i++), o)) {
                case "\\":
                  ")" === t.GetCS() && (o = "\\(");
                case "$":
          ...
          CheckAutoload: function (t, e) {
            var a = t.configuration.packageData.get("autoload"),
              n = t.texParser;
            e = e.slice(1);
            var r = n.lookup("macro", e);
            if (!r || (a && r._func === a.Autoload)) {
              if ((n.parse("macro", [n, e]), !r)) return;
              o.retryAfter(Promise.resolve());
            }
            n.parse("macro", [t, e]);
          },
          Macro: r.default.Macro,
          Spacer: r.default.Spacer,
          Hskip: r.default.Hskip,
          rule: r.default.rule,
          Rule: r.default.Rule,
          HandleRef: r.default.HandleRef,
        };
      },
      787: function (t, e, a) {
        var n,
          ...
          i =
            ...
            function (t, e) {
              for (var a = 0, n = e.length, o = t.length; a < n; a++, o++)
                t[o] = e[a];
              return t;
            };
        Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            return (
              ...
              (e.prototype.Error = function (t, e) {
                for (var a = [], n = 2; n < arguments.length; n++)
                  a[n - 2] = arguments[n];
                throw new (l.default.bind.apply(
                  l.default,
                  i([void 0, t, e], s(a))
                ))();
              }),
  ...
  function s(t) {
    ...
    var a = (r[t] = { exports: {} });
    return o[t].call(a.exports, a, a.exports, s), a.exports;
  }
  (t = s(955)),
    (e = s(762)),
    (a = s(807)),
