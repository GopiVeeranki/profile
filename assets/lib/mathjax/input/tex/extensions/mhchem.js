!(function () {
    ...
    o = {
      78: function (t, e, o) {
        ...
        var n = o(251),
          ...
          c = o(652),
          u = {};
        (u.Macro = i.default.Macro),
          (u.xArrow = p.AmsMethods.xArrow),
          (u.Machine = function (t, e, o) {
            try {
              var n = t.GetArgument(e),
                a = c.mhchemParser.toTex(n, o);
        ...
        var a = {
            ...
            patterns: {
              ...
              findObserveGroups: function (t, e, o, n, a, r, i, p, c, u) {
                ...
                if (((t = t.substr(_.length)), null === (_ = s(t, o))))
                  return null;
            ...
            actions: {
              ...
              "1/2": function (t, e) {
                var o = [];
                e.match(/^[+\-]/) &&
                  (o.push(e.substr(0, 1)), (e = e.substr(1)));
                var n = e.match(
                  /^([0-9]+|\$[a-z]\$|[a-z])\/([0-9]+)(\$[a-z]\$|[a-z])?$/
                );
                return (
              ...
              ce: {
                ...
                actions: {
                  "o after d": function (t, e) {
                    ...
                    if ((t.d || "").match(/^[0-9]+$/)) {
                      var n = t.d;
                      (t.d = void 0), (o = this.output(t)), (t.b = n);
          ...
          r = {
            ...
            _go2: function (t) {
              ...
              switch (t.type_) {
                ...
                case "color":
                  e =
                    "{\\color{" + t.color1 + "}{" + r._goInner(t.color2) + "}}";
                  break;
                case "color0":
                  e = "\\color{" + t.color + "}";
                  break;
  ...
  (t = a(955)),
    (e = a(78)),
    (0, t.r8)({
      _: { input: { tex: { mhchem: { MhchemConfiguration: e } } } },
    });
})();
