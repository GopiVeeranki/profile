!(function () {
  ...
  var t,
    ...
    e = {
      133: function (t, a, e) {
        ...
        (a.BboxMethods = {}),
          (a.BboxMethods.BBox = function (t, a) {
            for (
              ...
              var s = x[M].trim(),
                f = s.match(/^(\.\d+|\d+(\.\d*)?)(pt|em|ex|mu|px|in|cm|mm)$/);
              if (f) {
                if (e)
                  throw new i.default(
                ...
                s.match(/^([a-z0-9]+|\#[0-9a-f]{6}|\#[0-9a-f]{3})$/i)
              ) {
                if (o)
                  throw new i.default(
                    "MultipleBBoxProperty",
        ...
        new n.CommandMap("bbox", { bbox: "BBox" }, a.BboxMethods),
          (a.BboxConfiguration = o.Configuration.create("bbox", {
            handler: { macro: ["bbox"] },
          }));
      },
      955: function (t, a) {
  ...
  (t = n(955)),
    (a = n(133)),
    (0, t.r8)({ _: { input: { tex: { bbox: { BboxConfiguration: a } } } } });
})();
