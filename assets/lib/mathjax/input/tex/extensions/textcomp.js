!(function () {
        ...
        new r.CommandMap(
          ...
          },
          {
            Insert: function (t, e, n, r) {
              if (t instanceof x.TextParser) {
                if (!r) return void s.TextMacrosMethods.Insert(t, e, n);
                t.saveText();
              }
              t.Push(o.default.internalText(t, n, r ? { mathvariant: r } : {}));
            },
          }
        );
      },
  ...
  function a(t) {
    ...
    var s = (r[t] = { exports: {} });
    return n[t](s, s.exports, a), s.exports;
  }
  (t = a(955)),
    (e = a(845)),
    (0, t.r8)({
      _: { input: { tex: { textcomp: { TextcompConfiguration: e } } } },
    });
})();
