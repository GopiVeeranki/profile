!(function () {
    ...
    l = {
      205: function (t, e, a) {
        ...
        function c(t) {
          ...
          try {
            for (
              var m = o(u.getList("mmultiscripts")), d = m.next();
              !d.done;
              d = m.next()
            ) {
              var c = d.value;
              if (c.getProperty("fixPrescript")) {
                var h = i.default.getChildren(c),
                  p = 0;
                try {
                  for (
                ...
                try {
                  for (
                    ...
                    var y = g.value;
                    i.default.isType(h[y], "mrow") &&
                      0 === i.default.getChildren(h[y]).length &&
                      i.default.setChild(
                        c,
                        y,
                        u.nodeFactory.create("node", "none")
        ...
        (e.PAIREDDELIMS = "mathtools-paired-delims"),
          (e.fixPrescripts = c),
          (e.MathtoolsConfiguration = n.Configuration.create("mathtools", {
            handler: {
            ...
            items:
              ((r = {}),
              (r[d.MultlinedItem.prototype.kind] = d.MultlinedItem),
              r),
            init: function (t) {
              new l.CommandMap(e.PAIREDDELIMS, {}, {}),
                t.append(
            ...
            config: function (t, e) {
              ...
              try {
                for (
                  ...
                  var d = s.value;
                  u.MathtoolsUtil.addPairedDelims(n, d, l[d]);
                }
              } catch (t) {
                a = { error: t };
              } finally {
            ...
            options: {
              mathtools: {
                ...
                pairedDelimiters: s.expandable({}),
                tagforms: s.expandable({}),
              },
            },
          }));
      },
              ...
              (e.prototype.EndTable = function () {
                if (
                  ...
                  var e = this.factory.configuration.options.mathtools,
                    ...
                    n = l.default.getChildren(this.table[0])[0];
                  l.default.getAttribute(n, "columnalign") !==
                    i.TexConstant.Align.RIGHT &&
                    n.appendChild(
                      this.create("node", "mspace", [], { width: r })
                    );
                  var s = l.default.getChildren(
                    this.table[this.table.length - 1]
                  )[0];
                  if (
                    l.default.getAttribute(s, "columnalign") !==
                    i.TexConstant.Align.LEFT
                  ) {
                    var u = l.default.getChildren(s)[0];
                    u.childNodes.unshift(null);
                    var m = this.create("node", "mspace", [], { width: o });
                    l.default.setChild(u, 0, m);
                  }
                }
      ...
      926: function (t, e, a) {
        ...
        new o.CommandMap(
          ...
          new o.DelimiterMap("mathtools-delimiters", r.default.delimiter, {
            "\\lparen": "(",
            "\\rparen": ")",
          }),
          new o.CommandMap(
      ...
      178: function (t, e, a) {
        ...
        e.MathtoolsMethods = {
          MtMatrix: function (t, a, r, o) {
            var n = t.GetBrackets("\\begin{" + a.getName() + "}", "c");
          ...
          SpreadLines: function (t, e) {
            ...
            if (t.stack.env.closing === e.getName()) {
              ...
              if (l.isInferred)
                try {
                  for (
                    var s = n(d.default.getChildren(l)), u = s.next();
                    !u.done;
                    u = s.next()
                  ) {
                    var m = u.value;
                    x.MathtoolsUtil.spreadLines(m, i);
                  }
                } catch (t) {
                  a = { error: t };
                } finally {
              ...
              else x.MathtoolsUtil.spreadLines(l, i);
              t.Push(l);
            } else {
              i = t.GetDimen("\\begin{" + e.getName() + "}");
          ...
          MathLap: function (t, e, a, o) {
            ...
            x.MathtoolsUtil.setDisplayLevel(l, n),
          ...
          Cramped: function (t, e) {
            ...
            x.MathtoolsUtil.setDisplayLevel(o, a), t.Push(o);
          },
          MtLap: function (t, e, a) {
            var r = l.default.internalMath(t, t.GetArgument(e), 0),
          ...
          MathMakeBox: function (t, e) {
            ...
            a && d.default.setAttribute(o, "width", a);
            var n = p.lookup(r, { c: "center", r: "right" }, "");
            n && d.default.setAttribute(o, "data-align", n), t.Push(o);
          },
          ...
          UnderOverBracket: function (t, e) {
            var a,
              r = h.length2em(t.GetBrackets(e, ".1em"), 0.1),
              ...
              M = h.em(r),
              x = h.em(2 * r),
              g = new u.default(i, t.stack.env, t.configuration).mml(),
              y = new u.default(i, t.stack.env, t.configuration).mml(),
              v = t.create(
                "node",
                "mpadded",
                [
                  t.create(
                    "node",
                    "mpadded",
                    [t.create("node", "mphantom", [y])],
                    {
                      style: "border: " + M + " solid; border-" + p + ": none",
                      width: "-" + x,
                      height: n,
                      depth: 0,
                    }
              ...
              b = l.default.underOver(t, g, v, m, !0),
              _ = d.default.getChildAt(d.default.getChildAt(b, 0), 0);
            d.default.setAttribute(_, c, !0), t.Push(b);
          },
          Aboxed: function (t, e) {
            var a = x.MathtoolsUtil.checkAlignment(t, e);
            ...
            var s = l.default.substituteArgs(
              t,
              [n, i],
          ...
          ArrowBetweenLines: function (t, e) {
            ...
            var n = r ? "\\quad" + o : o + "\\quad",
              l = new u.default(n, t.stack.env, t.configuration).mml();
          ...
          PairedDelimiters: function (t, e, a, r, n, i, s, u) {
            void 0 === n && (n = "#1"),
              void 0 === i && (i = 1),
              void 0 === s && (s = ""),
              void 0 === u && (u = "");
            var m = t.GetStar(),
              ...
              f = m ? "\\middle" : d || "";
            if (i) {
              for (var M = [], x = M.length; x < i; x++)
                M.push(t.GetArgument(e));
              n = l.default.substituteArgs(t, M, n);
            }
            (n = n.replace(/\\delimsize/g, f)),
              (t.string = [s, h, a, n, p, r, u, t.string.substr(t.i)].reduce(
                function (e, a) {
                  return l.default.addArgs(t, e, a);
                },
                ""
              )),
              (t.i = 0),
          ...
          DeclarePairedDelimiters: function (t, e) {
            var a = f.default.GetCsNameArgument(t, e),
              r = t.GetArgument(e),
              o = t.GetArgument(e);
            x.MathtoolsUtil.addPairedDelims(t.configuration, a, [r, o]);
          },
          DeclarePairedDelimitersX: function (t, e) {
            var a = f.default.GetCsNameArgument(t, e),
              r = f.default.GetArgCount(t, e),
              o = t.GetArgument(e),
              n = t.GetArgument(e),
              l = t.GetArgument(e);
            x.MathtoolsUtil.addPairedDelims(t.configuration, a, [o, n, l, r]);
          },
          DeclarePairedDelimitersXPP: function (t, e) {
            var a = f.default.GetCsNameArgument(t, e),
              ...
              i = t.GetArgument(e),
              s = t.GetArgument(e);
            x.MathtoolsUtil.addPairedDelims(t.configuration, a, [
              n,
              l,
              s,
              r,
          ...
          Relation: function (t, e, a, r) {
            t.options.mathtools["use-unicode"] && r
              ? t.Push(t.create("token", "mo", { texClass: c.TEXCLASS.REL }, r))
              : ((a =
                  "\\mathrel{" +
                  a
                    ...
                    .replace(/-/g, "\\mathrel{-}") +
                  "}"),
                (t.string = l.default.addArgs(t, a, t.string.substr(t.i))),
                (t.i = 0));
          },
          ...
          XMathStrut: function (t, e) {
            var a = t.GetBrackets(e),
              r = t.GetArgument(e);
            (r = x.MathtoolsUtil.plusOrMinus(e, r)),
              (a = x.MathtoolsUtil.plusOrMinus(e, a || r)),
              t.Push(
                t.create(
                  "node",
                  "TeXAtom",
                  ...
                  { texClass: c.TEXCLASS.ORD }
                )
              );
          },
          Prescript: function (t, e) {
            var a = x.MathtoolsUtil.getScript(t, e, "sup"),
              r = x.MathtoolsUtil.getScript(t, e, "sub"),
              o = x.MathtoolsUtil.getScript(t, e, "arg");
            if (d.default.isType(a, "none") && d.default.isType(r, "none"))
              t.Push(o);
            else {
              var n = t.create("node", "mmultiscripts", [o]);
              d.default.getChildren(n).push(null, null),
                d.default.appendChildren(n, [
          ...
          SetOptions: function (t, e) {
            ...
            if (!o["allow-mathtoolsset"])
              throw new m.default("ForbiddenMathtoolsSet", "%1 is disabled", e);
            var i = {};
            ...
            var s = t.GetArgument(e),
              u = l.default.keyvalOptions(s, i, !0);
            try {
              for (
                var d = n(Object.keys(u)), c = d.next();
                !c.done;
                c = d.next()
              ) {
                var h = c.value;
          ...
          Array: s.default.Array,
          Macro: s.default.Macro,
          xArrow: i.AmsMethods.xArrow,
          HandleRef: i.AmsMethods.HandleRef,
          AmsEqnArray: i.AmsMethods.AmsEqnArray,
          MacroWithTemplate: M.default.MacroWithTemplate,
        };
      },
      298: function (t, e, a) {
        var r,
        ...
        e.MathtoolsTagFormat = function (t, e) {
          ...
          "base" !== a &&
            t.tags.hasOwnProperty(a) &&
            s.TagsFactory.add(a, t.tags[a]);
          var r = (function (t) {
              function a() {
                var a,
                  r,
                ...
                try {
                  for (
                    var s = n(Object.keys(l)), u = s.next();
                    !u.done;
                    u = s.next()
                  ) {
                    var m = u.value;
                    if (!Array.isArray(l[m]) || 3 !== l[m].length)
                      throw new i.default(
                        "InvalidTagFormDef",
                        'The tag form definition for "%1" should be an array fo three strings',
                        m
                      );
                    o.mtFormats.set(m, l[m]);
                  }
                } catch (t) {
                  a = { error: t };
                } finally {
                ...
                (a.prototype.formatTag = function (e) {
                  if (this.mtCurrent) {
                    var a = l(this.mtCurrent, 3),
                      ...
                      o = a[1],
                      n = a[2];
                    return n ? "" + r + n + "{" + e + "}" + o : "" + r + e + o;
                  }
                  return t.prototype.formatTag.call(this, e);
                }),
                a
              );
            })(s.TagsFactory.create(e.parseOptions.options.tags).constructor),
            m = "MathtoolsTags-" + ++u;
          s.TagsFactory.add(m, r), (e.parseOptions.options.tags = m);
        };
      },
      262: function (t, e, a) {
        var r =
        ...
        e.MathtoolsUtil = {
          ...
          checkAlignment: function (t, e) {
            var a = t.stack.Top();
            if (a.kind !== o.EqnArrayItem.prototype.kind)
              throw new i.default(
                "NotInAlignment",
          ...
          addPairedDelims: function (t, e, a) {
            t.handlers
              ...
              .add(e, new s.Macro(e, m.MathtoolsMethods.PairedDelimiters, a));
          },
          spreadLines: function (t, e) {
            if (t.isKind("mtable")) {
              var a = t.attributes.get("rowspacing");
              if (a) {
                var r = n.default.dimen2em(e);
                a = a
                  .split(/ /)
                  .map(function (t) {
                    return n.default.Em(Math.max(0, n.default.dimen2em(t) + r));
                  })
                  .join(" ");
              } else a = e;
          ...
          getScript: function (t, e, a) {
            var r = n.default.trimSpaces(t.GetArgument(e));
            if ("" === r) return t.create("node", "none");
            var o = t.options.mathtools["prescript-" + a + "-format"];
            return (
              o && (r = o + "{" + r + "}"),
              new l.default(r, t.stack.env, t.configuration).mml()
            );
          },
        };
      },
  ...
  function s(t) {
    ...
    var a = (i[t] = { exports: {} });
    return l[t].call(a.exports, a, a.exports, s), a.exports;
  }
  (t = s(955)),
    (e = s(205)),
    (a = s(144)),
