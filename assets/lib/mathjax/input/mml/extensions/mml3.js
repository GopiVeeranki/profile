(function () {
      ...
      514: function (e, t, l) {
        var s,
          ...
          o =
            ...
            function (e, t) {
              for (var l = 0, s = t.length, n = e.length; l < s; l++, n++)
                e[n] = t[l];
              return e;
            },
          a =
          ...
          c = (function () {
            function e(t) {
              if ("undefined" == typeof XSLTProcessor)
                this.transform = r.createTransform();
              else {
                ...
                l.importStylesheet(s),
                  (this.transform = function (e) {
                    ...
                    return s.serializeXML(s.body(m));
                  });
              }
            }
            return (
              (e.prototype.preFilter = function (e) {
                e.data = this.transform(e.data);
              }),
              e
            );
          })();
        (t.Mml3 = c),
          (t.Mml3Handler = function (e) {
            return (
              (e.documentClass = (function (e) {
                function t() {
                  for (var t, l, s = [], n = 0; n < arguments.length; n++)
                    s[n] = arguments[n];
                  var r = e.apply(this, o([], m(s))) || this,
                    i = s[2];
                  if (i.InputJax)
                    try {
                      for (
                        var p = a(i.InputJax), x = p.next();
                        !x.done;
                        x = p.next()
                      ) {
                        var d = x.value;
                        if ("MathML" === d.name) {
                          if (!d.options._mml3) {
                            var h = new c(r);
                            d.preFilters.add(h.preFilter.bind(h)),
                              (d.options._mml3 = !0);
                          }
                          break;
                        }
  ...
  function __webpack_require__(e) {
    ...
    return (
      __webpack_modules__[e].call(l.exports, l, l.exports, __webpack_require__),
      l.exports
    );
  }
  ...
  (global = __webpack_require__(955)),
    ...
    (0, global.r8)({
      _: {
        input: { mathml: { mml3: { "mml3-node": mml3_node, mml3: mml3 } } },
      },
    }),
    MathJax.startup &&
