(function () {
  ...
  var __webpack_modules__ = {
      ...
      1168: function (t, e) {
        ...
        var a = function (t, e, a) {
          ...
          void 0 === e && (e = {}),
            ...
            (this.children = o([], n(a)));
          try {
            for (var u = i(this.children), c = u.next(); !c.done; c = u.next())
              c.value.parent = this;
          } catch (t) {
            s = { error: t };
          } finally {
          ...
          return (
            (t.prototype.parseFromString = function (t, e, r) {
              ...
              for (
                ...
                var s = a.shift(),
                  l = a.shift();
                s && this.addText(r, o, s),
                  l &&
                    ">" === l.charAt(l.length - 1) &&
                    ("!" === l.charAt(1)
                      ? this.addComment(r, o, l)
                      : (o =
                          "/" === l.charAt(1)
                            ? this.closeTag(r, o, l)
                            : this.openTag(r, o, l, a)));
              }
              return this.checkDocument(r, n), n;
            }),
            (t.prototype.addText = function (t, e, r) {
              return (r = a.translate(r)), t.append(e, t.text(r));
            }),
            (t.prototype.addComment = function (t, e, r) {
              return t.append(e, new l.LiteComment(r));
            }),
            ...
            (t.prototype.openTag = function (t, e, r, n) {
              var o = this.constructor.PCDATA,
                ...
                u = r.replace(/^<.*?[\s\n>]/, "").split(i.attrsplit);
              return (
                (u.pop().match(/>$/) || u.length < 5) &&
                  (this.addAttributes(t, l, u),
                  t.append(e, l),
                  a[s] ||
                    r.match(/\/>$/) ||
                    (o[s] ? this.handlePCDATA(t, l, s, n) : (e = l))),
                e
              );
            }),
            (t.prototype.addAttributes = function (t, e, r) {
              for (var o = this.constructor.CDATA_ATTR; r.length; ) {
                var i = n(r.splice(0, 5), 5),
                  s = i[1],
                  l = i[2],
                  u = i[3],
                  c = i[4],
                  p = l || u || c || "";
                o[s] || (p = a.translate(p)), t.setAttribute(e, s, p);
              }
            }),
            ...
            (t.prototype.checkDocument = function (t, e) {
              var r,
                ...
                i,
                a,
                s = this.getOnlyChild(t, t.body(e));
              if (s) {
                try {
                  for (
                    var u = o(t.childNodes(t.body(e))), c = u.next();
                    !c.done;
                    c = u.next()
                  ) {
                    if ((h = c.value) === s) break;
                    h instanceof l.LiteComment &&
            ...
            (t.prototype.getOnlyChild = function (t, e) {
              ...
              try {
                for (
                  var a = o(t.childNodes(e)), l = a.next();
                  !l.done;
                  l = a.next()
                ) {
                  var u = l.value;
                  if (u instanceof s.LiteElement) {
                    if (i) return null;
                    i = u;
                  }
                }
          ...
          m = (function (t) {
            function e(e) {
              ...
              var r = t.call(this) || this,
                n = r.constructor;
              return (
                (r.options = O.userOptions(O.defaultOptions({}, n.OPTIONS), e)),
                (r.parser = new d.LiteParser()),
                (r.window = new h.LiteWindow()),
                r
              );
            }
            return (
              ...
              (e.prototype.getElements = function (t, e) {
                ...
                try {
                  for (var s = a(t), l = s.next(); !l.done; l = s.next()) {
                    ...
                    if ("string" == typeof u)
                      if ("#" === u.charAt(0)) {
                        var c = this.elementById(i, u.slice(1));
                        c && o.push(c);
                      } else
                        "." === u.charAt(0)
                          ? (o = o.concat(this.elementsByClass(i, u.slice(1))))
                          : u.match(/^[-a-z][-a-z0-9]*$/i) &&
                            (o = o.concat(this.tags(i, u)));
                    else
                      Array.isArray(u)
                        ? (o = o.concat(u))
              ...
              (e.prototype.split = function (t, e) {
                var r = new f.LiteText(t.value.slice(e));
                return (
              ...
              (e.prototype.nodeSize = function (t, r, n) {
      ...
      9515: function (t, e, r) {
        ...
        function i(t, e) {
          ...
          try {
            for (
              ...
              var u = l.value;
              "__esModule" !== u &&
                (!o(t[u]) || !o(e[u]) || e[u] instanceof Promise
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.isObject = o),
          (e.combineConfig = i),
          (e.combineDefaults = function t(e, r, i) {
            var a, s;
            e[r] || (e[r] = {}), (e = e[r]);
            try {
              for (
                var l = n(Object.keys(i)), u = l.next();
                !u.done;
                u = l.next()
              ) {
                var c = u.value;
      ...
      235: function (t, e, r) {
        ...
        if (
            ...
            (t.ready = function () {
              ...
              try {
                for (var a = i(r), l = a.next(); !l.done; l = a.next()) {
                  var u = l.value,
                    c = s.Package.packages.get(u) || new s.Package(u, !0);
                  o.push(c.promise);
                }
              } catch (e) {
                t = { error: e };
              ...
              (t.load = function () {
                ...
                try {
                  for (var l = i(n), u = l.next(); !u.done; u = l.next()) {
                    var c = u.value,
                      p = s.Package.packages.get(c);
                    p || (p = new s.Package(c)).provides(e.CONFIG.provides[c]),
                      p.checkNoLoad(),
                      a.push(p.promise);
                  }
                } catch (e) {
              ...
              (t.preLoad = function () {
                ...
                try {
                  for (var a = i(n), l = a.next(); !l.done; l = a.next()) {
                    var u = l.value,
                      c = s.Package.packages.get(u);
                    c ||
                      (c = new s.Package(u, !0)).provides(e.CONFIG.provides[u]),
                      c.loaded();
                  }
                } catch (e) {
                  t = { error: e };
              ...
              (t.pathFilters = new c.FunctionList()),
          ...
          a.combineDefaults(e.MathJax.config, "loader", {
            paths: { mathjax: u.getRoot() },
            source: {},
            dependencies: {},
            provides: {},
            load: [],
          ...
          return (
            ...
            (t.prototype.makeDependencies = function () {
              ...
              l.CONFIG.dependencies.hasOwnProperty(c)
                ? p.push.apply(p, s([], a(l.CONFIG.dependencies[c])))
                : "core" !== c && p.push("core");
              try {
            ...
            (t.prototype.makePromise = function (t) {
              ...
              return (
                ...
                n.failed &&
                  r.catch(function (t) {
                    return n.failed(new u(t, e.name));
                  }),
                r
              );
            }),
        ...
        !(function (t) {
          ...
          function h() {
            (s =
              ...
              (t.handler = g()),
              t.handler && (l.handlers.register(t.handler), (t.document = x()));
          }
          function d() {
            var e, r;
            t.input && t.output && y();
          ...
          function M() {
            ...
            try {
              for (
                ...
                i.push(new u(e.MathJax.config[l]));
              }
            } catch (t) {
              r = { error: t };
            } finally {
          ...
          void 0 === e.MathJax._.startup &&
            (l.combineDefaults(e.MathJax.config, "startup", {
              input: [],
              output: "",
              handler: null,
              adaptor: null,
            ...
            l.combineWithMathJax({ startup: s, options: {} }),
            e.MathJax.config.startup.invalidOption &&
              (c.OPTIONS.invalidOption =
                e.MathJax.config.startup.invalidOption),
            e.MathJax.config.startup.optionError &&
              (c.OPTIONS.optionError = e.MathJax.config.startup.optionError)),
        ...
        var n = r(7233),
          ...
          i = (function () {
            function t(t) {
              ...
              var e = this.constructor;
              (this.options = n.userOptions(
                n.defaultOptions({}, e.OPTIONS),
                t
              )),
          ...
          b = (function () {
            function t(e, r, n) {
              var o = this,
                i = this.constructor;
              (this.document = e),
                (this.options = l.userOptions(
                  l.defaultOptions({}, i.OPTIONS),
                  n
                )),
            ...
            return (
              ...
              (t.prototype.reset = function (t) {
                ...
                return (
                  ...
                  (t = l.userOptions(Object.assign({}, e.resetOptions), t))
                    .all && Object.assign(t, e.resetAllOptions),
                  t.processed && this.processed.reset(),
                  t.inputJax &&
                    this.inputJax.forEach(function (e) {
                      return e.reset.apply(e, s([], a(t.inputJax)));
                    }),
                  t.outputJax &&
                    (r = this.outputJax).reset.apply(r, s([], a(t.outputJax))),
                  this
                );
              }),
              ...
              (t.prototype.clearMathItemsWithin = function (t) {
                ...
                return (e = this.math).remove.apply(e, s([], a(r))), r;
              }),
      ...
      6336: function (t, e, r) {
        ...
        e.MML =
          ...
          (n[x.MmlMsub.prototype.kind] = x.MmlMsub),
          (n[x.MmlMsup.prototype.kind] = x.MmlMsup),
          (n[x.MmlMsubsup.prototype.kind] = x.MmlMsubsup),
          (n[L.MmlMunder.prototype.kind] = L.MmlMunder),
          (n[L.MmlMover.prototype.kind] = L.MmlMover),
          (n[L.MmlMunderover.prototype.kind] = L.MmlMunderover),
          ...
          (n[A.MmlMalignmark.prototype.kind] = A.MmlMalignmark),
              ...
              (e.prototype.checkPrimes = function (t) {
                ...
                if (t.match(e)) {
                  var r = this.constructor.remapPrimes,
                    n = c.unicodeString(
                      c.unicodeChars(t).map(function (t) {
                        return r[t];
                      })
                    );
            ...
            return (
              ...
              (e.prototype.setChildInheritedAttributes = function (t, e, r, n) {
                ...
                var f = this.attributes.getExplicit("data-cramped"),
                  h = l.split(this.attributes.get("rowalign"));
                try {
                  for (
      ...
      4082: function (t, e, r) {
        ...
        (e.OPDEF = i),
          ...
          (e.RANGES = [
            ...
            [131072, 195103, o.TEXCLASS.ORD, "mi"],
          ]),
            ...
            (r.prototype.getDataAttributes = function (t) {
              ...
              if (void 0 !== o) {
                ...
                if (o === l.TEXCLASS.OP && t.isKind("mi")) {
                  var a = t.getText();
                  i = !(a.length > 1 && a.match(u.MmlMi.operatorName));
                }
                i &&
          ...
          return (
            ...
            (t.prototype.setNodeClass = function (t, e) {
              ...
              this.node[t] = function () {
                for (var t = [], e = 0; e < arguments.length; e++)
                  t[e] = arguments[e];
                return new (i.bind.apply(i, o([void 0, r], n(t))))();
              };
            }),
        ...
        var a = (function () {
          ...
          return (
            ...
            (t.prototype.replaceChild = function (t, e) {
              var r = this.childIndex(e);
              return (
                null !== r && ((this.childNodes[r] = t), (t.parent = this)), t
              );
            }),
                ...
                if (t instanceof a.AbstractNode)
                  try {
                    for (
                      ...
                      var p = c.value;
                      this.visitNode.apply(this, i([p], o(s)));
                    }
                  } catch (t) {
                    e = { error: t };
                  } finally {
        ...
        var s = (function (t) {
          ...
          return (
            ...
            (e.prototype.wrap = function (t) {
              for (var e = [], r = 1; r < arguments.length; r++)
                e[r - 1] = arguments[r];
              return this.create.apply(this, a([t.kind, t], i(e)));
            }),
            e
          );
        })(r(4574).AbstractFactory);
      ...
      3683: function (t, e, r) {
        ...
        var l = r(5722),
          ...
          d = (function (t) {
            function e(e, r, n) {
              var o = this,
                i = a(u.separateOptions(n, f.HTMLDomStrings.OPTIONS), 2),
                s = i[0],
                l = i[1];
              return (
        ...
        var o = r(7233),
          i = (function () {
            function t(t) {
              void 0 === t && (t = null);
              var e = this.constructor;
              (this.options = o.userOptions(
                o.defaultOptions({}, e.OPTIONS),
                t
              )),
                this.init(),
                this.getPatterns();
      ...
      6751: function (t, e) {
        ...
        (e.BitField = s),
          (e.BitFieldClass = function () {
            ...
            return r.allocate.apply(r, a([], i(t))), r;
          });
      },
      5368: function (t, e, r) {
        Object.defineProperty(e, "__esModule", { value: !0 }),
              ...
              return new Promise(function (e, o) {
                !(function i() {
                  for (var l; ++r < n.length; ) {
                    var u = (l = n[r]).item.apply(l, s([], a(t)));
      ...
      7233: function (t, e) {
            ...
            if (
              ...
              ((1 === d.length &&
                ...
                ? (f[e.REMOVE] &&
                  ...
                  f[e.APPEND] && (t[r] = o(o([], n(h)), n(f[e.APPEND]))))
                : p(h, f, l);
            }
          };
          try {
        ...
        (e.Expandable = s),
          ...
          (e.selectOptionsFromKeys = function (t, e) {
            return f.apply(void 0, o([t], n(Object.keys(e))));
          }),
      ...
      505: function (t, e) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.unicodeString = function (t) {
            return String.fromCodePoint.apply(String, n([], r(t)));
          }),
      ...
      3226: function (t, e, r) {
        ...
        var n = "/",
          o = {
            ...
            "[tex]/action": "".concat(
              n,
              "/input/tex/extensions/action/action.js"
            ),
            ...
            "[tex]/braket": "".concat(
              n,
              "/input/tex/extensions/braket/braket.js"
            ),
            ...
            "[tex]/cancel": "".concat(
              n,
              "/input/tex/extensions/cancel/cancel.js"
            ),
            ...
            "[tex]/colorv2": "".concat(
              n,
              "/input/tex/extensions/colorv2/colorv2.js"
            ),
            ...
            "[tex]/enclose": "".concat(
              n,
              "/input/tex/extensions/enclose/enclose.js"
            ),
            "[tex]/extpfeil": "".concat(
              n,
            ...
            "[tex]/mhchem": "".concat(
              n,
              "/input/tex/extensions/mhchem/mhchem.js"
            ),
            ...
            "[tex]/physics": "".concat(
              n,
              "/input/tex/extensions/physics/physics.js"
            ),
            "[tex]/require": "".concat(
              n,
              "/input/tex/extensions/require/require.js"
            ),
            ...
            "output/chtml/fonts/tex": "".concat(
              n,
              "/output/chtml/fonts/tex/tex.js"
            ),
            "output/svg": "".concat(n, "/output/svg/svg.js"),
            "output/svg/fonts/tex": "".concat(
              n,
              "/output/svg/fonts/tex/tex.js"
            ),
            "a11y/assistive-mml": "".concat(
              n,
  ...
  !(function () {
    ...
    var _require = __webpack_require__(235),
      ...
      _require3 = __webpack_require__(4038),
      dependencies = _require3.dependencies,
      paths = _require3.paths,
      provides = _require3.provides;
