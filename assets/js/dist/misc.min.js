...
!(function () {
  ...
  function Ut(t) {
    for (var e = Tt(t), n = Yt(t); n && Rt(n) && "static" === Wt(n).position; )
      n = Yt(n);
    return n &&
  ...
  function le(t) {
    return It(qt(t)).left + ce(t).scrollLeft;
  }
  function ue(t) {
    var e = Wt(t),
      n = e.overflow,
  ...
  function ve(t, e) {
    ...
    var n = e,
      ...
      y = t.rects.popper,
      _ = t.elements[h ? b : d],
      w = ge(Lt(_) ? _ : _.contextElement || qt(t.elements.popper), c, u, s),
      ...
      if (E) {
        if (r) {
          var j,
            ...
            q = W[D],
            V = Qt(0, O[k], z[k]),
            Y = y ? O[k] / 2 - B - V - R - C.mainAxis : F - V - R - C.mainAxis,
            U = y ? -O[k] / 2 + B + V + q + C.mainAxis : I + V + q + C.mainAxis,
  ...
  class fn {
    static initBar() {
      new IntersectionObserver(
        ...
        { rootMargin: "-".concat(D(fn, this, pn)._, "px 0px 0px 0px") },
      ).observe(rn),
        (dn._ = D(fn, this, !1));
    }
    ...
    static refresh() {
      D(fn, this, dn)._ && this.initComponents(),
    ...
    static initComponents() {
      this.initBar(),
        ...
        (an.onclick = (t) => this.clickBackdrop(t)),
  ...
  k(fn, "options", {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: D((nn = fn), nn, pn)._,
  });
  k(
    class {
      static refresh() {
      ...
      static init() {
        const t = document.getElementById("toc-wrapper");
        t && (tocbot.init(this.options), t.classList.remove("invisible"));
      }
    },
    "options",
    {
  ...
  class bn {
    static toggle() {
      (yn._ = D(bn, this, !D(bn, this, yn)._)),
        document.body.toggleAttribute("sidebar-display", D(bn, this, yn)._),
        gn.classList.toggle("z-2", D(bn, this, yn)._),
        vn.classList.toggle("d-none", !D(bn, this, yn)._);
    }
  }
  var yn = { _: !1 };
  const _n = document.getElementById("sidebar-trigger"),
    ...
    Tn = document.getElementById("search-results"),
    Ln = document.getElementById("search-input"),
    jn = document.getElementById("search-hints"),
    Sn = "d-block",
    Dn = "d-none",
    kn = "input-focus",
    Pn = "d-flex";
  class Mn {
    ...
    static off() {
      En.classList.remove(Sn),
        ...
        _n.classList.remove(Dn),
        xn.classList.remove(Dn),
        wn.classList.remove(Dn);
    }
  }
  class Nn {
    static on() {
      this.resultVisible ||
        (Cn.classList.remove(Dn),
        On.forEach((t) => {
          t.classList.add(Dn);
        }),
    ...
    static off() {
      this.resultVisible &&
        ((Tn.innerHTML = ""),
        jn.classList.contains(Dn) && jn.classList.remove(Dn),
        Cn.classList.add(Dn),
        On.forEach((t) => {
  ...
  function Bn() {
    return En.classList.contains(Sn);
  }
  k(Nn, "resultVisible", !1),
    (mn.onclick = vn.onclick = () => bn.toggle()),
    wn.addEventListener("click", () => {
      Mn.on(), Nn.on(), Ln.focus();
    }),
    ...
    Ln.addEventListener("focusout", () => {
      An.classList.remove(kn);
    }),
    Ln.addEventListener("input", () => {
      "" === Ln.value
        ? Bn()
          ? jn.classList.remove(Dn)
          : Nn.off()
        : (Nn.on(), Bn() && jn.classList.add(Dn));
    }),
    dayjs.locale(en.locale),
    dayjs.extend(window.dayjs_plugin_localizedFormat),
    document
      .querySelectorAll("[".concat(en.attrTimestamp, "]"))
      .forEach((t) => {
        const e = dayjs.unix(en.getTimestamp(t)),
          n = e.format(en.getDateFormat(t));
        if (
          ((t.textContent = n),
          t.removeAttribute(en.attrTimestamp),
          t.removeAttribute(en.attrDateFormat),
